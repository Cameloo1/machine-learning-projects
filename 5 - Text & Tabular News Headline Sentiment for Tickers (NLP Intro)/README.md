...
- **Generated reports/figures**: Can be regenerated by running the notebook
- **Environment files** (`.env`): Contains API keys — never commit secrets

### Regenerating Artifacts
All excluded files can be regenerated by:
...
This keeps the repository lightweight while maintaining full reproducibility.
